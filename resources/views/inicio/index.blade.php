...
<head>
	...
	<link rel="stylesheet" href="ins/css/style.css">
...
<body>
	...
	<header class="full-reset header">
		...
		<div class="full-reset logo">
			<span class="hidden-lg hidden-md">A Mi Mundo</span>
			<span class="hidden-xs hidden-sm">A Mi Mundo</span>
		</div>
		<!--======================================== Links de navegación ========================================-->
	...
	<!--======================================== Logo & Lema ========================================-->
	<section class="full-reset font-cover" style="background-image: url(ins/assets/img/font-index.jpg);">
		<div class="full-reset" style="height: 100%; background-color: rgba(255,255,255,.6); padding: 60px 0;">
			...
			<figure class="Logo-Ins-Index">
				<img src="ins/assets/img/logoSPI.png" alt="Logo" class="img-responsive">
			</figure>
					...
					<div id="slider-ins" class="carousel slide" data-ride="carousel">
					  ...
					  <div class="carousel-inner" role="listbox">
					    ...
					    <div class="item active">
					      <img src="{{asset('ins/assets/gallery/1.jpg')}}" alt="Default">
						...
						<!-- Segunda imagen -->
					    <div class="item">
					      <img src="{{asset('ins/assets/gallery/2.jpg')}}" alt="Default">
					      <div class="carousel-caption">
					        Lorem ipsum dolor sit amet
					      </div>
					    </div>
						...
						<!-- Tercera imagen -->
					    <div class="item">
					      <img src="{{asset('ins/assets/gallery/3.jpg')}}" alt="Default">
					      <div class="carousel-caption">
					        Lorem ipsum dolor sit amet
					      </div>
					    </div>
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<article class="col-xs-12 col-sm-6 col-md-4">
					<div class="thumbnail">
				      <img src="ins/assets/gallery/4.jpg" alt="IMG" class="img-responsive img-rounded">
				      <div class="caption">
				...
				<article class="col-xs-12 col-sm-6 col-md-4">
					<div class="thumbnail">
				      <img src="ins/assets/gallery/5.jpg" alt="IMG" class="img-responsive img-rounded">
				      <div class="caption">
				        <h3 class="text-center">Lorem ipsum dolor sit amet</h3>
				        <p class="text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis quam, incidunt, sapiente id quibusdam voluptatem.</p>
				        <p class="text-center"><a href="#" class="btn btn-primary" role="button">Ver imágenes</a></p>
				...
				<article class="col-xs-12 col-sm-6 col-md-4">
					<div class="thumbnail">
				      <img src="ins/assets/gallery/6.jpg" alt="IMG" class="img-responsive img-rounded">
				      <div class="caption">
				        <h3 class="text-center">Lorem ipsum dolor sit amet</h3>
				        <p class="text-justify">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Perferendis quam, incidunt, sapiente id quibusdam voluptatem.</p>
				        <p class="text-center"><a href="#" class="btn btn-primary" role="button">Ver imágenes</a></p>
		...
		<div class="full-reset" style="padding: 15px 0;">
			<div class="container">
				<div class="row">
					...
					<div class="col-xs-12">
						<div class="full-reset footer-copyright"><i class="fa fa-copyright"></i> 2021 Sonia Farfan</div>
					</div>
				</div>
			</div>
		</div>
